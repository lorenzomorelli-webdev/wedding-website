    ...
    $(function () {
        $(window).scroll(function () {
            ...
            if (scroll >= 20) {
                ...
                //$('.nav-toggle').removeClass('accent-bg-nav-toogle');
                $('.nav-toggle').addClass('white-bg');
            } else {
                ...
                $('.nav-toggle').removeClass('white-bg');
                //$('.nav-toggle').addClass('accent-bg');
            }
        });
    });
    /***************** Smooth Scrolling ******************/
    ...
    */
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'defa50a7babc2b727c44fe4e03905bf4') {
            ...
            $.post('https://script.google.com/macros/s/AKfycbzV8QaZ89hycN5io8XXgaoUiiQd8RJYk67w3QxdNVnp0_hd5aUlEsV7jBnr5zJ4nxTV/exec', data)
                .done(function (data) {
                    console.log(data);
